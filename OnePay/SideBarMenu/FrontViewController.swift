...
class FrontViewController: UIViewController {
    ...
    @objc var delegate: RevealViewController?

    override func viewDidLoad() {
        super.viewDidLoad()


        let navigationBarMenuBtnColor = UIColor(hexString: "#1F8395FF")
        let navigationBarBackGroundColor = UIColor(hexString: "#80D2E0FF")
        ...
        btnSideBar.tintColor = navigationBarMenuBtnColor
    ...
    @IBAction func sideBarMenuBtn(_ sender: Any) {
