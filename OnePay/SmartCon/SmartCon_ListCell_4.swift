...
protocol SmartCon_ListCell_4_Protocol {
    func smartCon_ListCell_4_Protocol(SmartCon_ListCell_4_Protocol: SmartCon_ListCell_4)
    func sendData(data: Array<Any>)

}

class SmartCon_ListCell_4: UITableViewCell,UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    var delegate:SmartCon_ListCell_4_Protocol?
    ...
    override func awakeFromNib() {
        ...
        cateBrandCodeArray = Data_SmartCon.shared.smartCon_brand_code_array["SmartCon_brand_code_5"]!
        cateBrandImageArray = Data_SmartCon.shared.smartCon_brand_img_array["SmartCon_brand_img_5"]!
        cateBrandNameArray = Data_SmartCon.shared.smartCon_brand_name_array["SmartCon_brand_name_5"]!
    ...
    @objc func imageViewTapped(imageView:UITapGestureRecognizer? = nil ) {
        ...
        self.delegate?.smartCon_ListCell_4_Protocol(SmartCon_ListCell_4_Protocol: self)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        sendBrandDataArray.append(self.cateNameArray[4])
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let cell: SmartConList_CollectionCell_4 = collectionView.dequeueReusableCell(withReuseIdentifier: "SmartConList_CollectionCell_4", for: indexPath) as? SmartConList_CollectionCell_4
        {
