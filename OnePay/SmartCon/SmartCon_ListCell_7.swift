...
protocol SmartCon_ListCell_7_Protocol {
    func smartCon_ListCell_7_Protocol(SmartCon_ListCell_7_Protocol: SmartCon_ListCell_7)
    func sendData(data: Array<Any>)

}

class SmartCon_ListCell_7: UITableViewCell,UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    var delegate:SmartCon_ListCell_7_Protocol?
    ...
    override func awakeFromNib() {
        ...
        cateBrandCodeArray = Data_SmartCon.shared.smartCon_brand_code_array["SmartCon_brand_code_8"]!
        cateBrandImageArray = Data_SmartCon.shared.smartCon_brand_img_array["SmartCon_brand_img_8"]!
        cateBrandNameArray = Data_SmartCon.shared.smartCon_brand_name_array["SmartCon_brand_name_8"]!
    ...
    @objc func imageViewTapped(imageView:UITapGestureRecognizer? = nil ) {
        ...
        self.delegate?.smartCon_ListCell_7_Protocol(SmartCon_ListCell_7_Protocol: self)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        sendBrandDataArray.append(self.cateNameArray[7])
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let cell: SmartConList_CollectionCell_7 = collectionView.dequeueReusableCell(withReuseIdentifier: "SmartConList_CollectionCell_7", for: indexPath) as? SmartConList_CollectionCell_7
        {
