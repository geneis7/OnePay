...
protocol SmartCon_ListCell_2_Protocol {
    func smartCon_ListCell_2_Protocol(SmartCon_ListCell_2_Protocol: SmartCon_ListCell_2)
    func sendData(data: Array<Any>)
}

class SmartCon_ListCell_2: UITableViewCell,UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {

    @IBOutlet weak var smartConList_CollCell: UICollectionView!
    @IBOutlet weak var headerView_2: UIView!
    ...
    var delegate:SmartCon_ListCell_2_Protocol?
    ...
    override func awakeFromNib() {
        ...
        cateBrandCodeArray = Data_SmartCon.shared.smartCon_brand_code_array["SmartCon_brand_code_3"]!
        cateBrandImageArray = Data_SmartCon.shared.smartCon_brand_img_array["SmartCon_brand_img_3"]!
        cateBrandNameArray = Data_SmartCon.shared.smartCon_brand_name_array["SmartCon_brand_name_3"]!
    ...
    @objc func imageViewTapped(imageView:UITapGestureRecognizer? = nil ) {
        ...
        self.delegate?.smartCon_ListCell_2_Protocol(SmartCon_ListCell_2_Protocol: self)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        sendBrandDataArray.append(self.cateNameArray[2])
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let cell: SmartConList_CollectionCell_2 = collectionView.dequeueReusableCell(withReuseIdentifier: "SmartConList_CollectionCell_2", for: indexPath) as? SmartConList_CollectionCell_2
        {
